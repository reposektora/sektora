                    ...
                    <div className="row row-cols-lg-1 row-cols-1">
                        ...
                        <div className="col align-self-center">
                            <div className="intro-content-two text-center mt-xl-8 mt-lg-8 mt-md-8 mt-sm-8 mt-xs-8">
                                <h2 className="title">Developing awesome innovative & cutting-edge technology </h2>
                                <div className="desc">
                                    <p>We are an Information Technology Company located in Silicon Valley. We think strategy, craft design,
