                            ...
                            <div className="entry-author">
                                <div className="author-info">
                                    ...
                                    <div className="author-description">
                                        <h6 className="author-name">Julia Rittenger</h6>
                                        <span className="designation">Solution Architect</span>
                                        <div className="author-biographical-info">
                                              She is a solution architect in Sektora and helps service design on Cloud Services.
                                        </div>
                                    </div>
                                </div>
                            </div>
