    ...
    return (
        <div className="footer-section section footer-bg-color">
            <div className="container">
                        ...
                        <div className="footer-widget">
                            ...
                            <div className="footer-widget-content">
                                <div className="content">
                                    ...
                                    <p><Link to={process.env.PUBLIC_URL + "/"}>(+1) 408 220 33 99</Link></p>
                                    <p><Link to={process.env.PUBLIC_URL + "/"}>info@sektora.net</Link> </p>
                                </div>
                ...
                <div className="row">
                    <div className="col">
                        <p className="copyright">&copy; {"2020"} <strong>Sektora</strong>  <a href="#"><strong></strong></a></p>
                    </div>
                </div>
