                ...
                <div className="row">
                    ...
                    <div className="offset-lg-1 col-lg-5" data-aos="fade-up" data-aos-delay="300">
                        <div className="success-content mt-lg-0 mt-md-50 mt-sm-50 mt-40">
                            <SectionTitleTwo 
                                subTitle="Your success is Sektora's success"
                                title="Architecture design, development &amp; Cloud solutions that get results"
                            />


                            <div className="progress-bar--one">
                                <div className="progress-charts">
                                    <h6 className="heading ">Backend Development</h6>
